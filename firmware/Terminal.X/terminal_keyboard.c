...
static const struct keys_entry se_entries[] = {
    [KEY_A] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('a'), KEY_CHR('A')),
                   KEY_CHR('\x01')),
    [KEY_B] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('b'), KEY_CHR('B')),
                   KEY_CHR('\x02')),
    [KEY_C] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('c'), KEY_CHR('C')),
                   KEY_CHR('\x03')),
    [KEY_D] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('d'), KEY_CHR('D')),
                   KEY_CHR('\x04')),
    [KEY_E] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_case, KEY_CHR('e'), KEY_CHR('E')),
                              KEY_CHR('\x05')),
                   KEY_STR("€")),
    [KEY_F] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('f'), KEY_CHR('F')),
                   KEY_CHR('\x06')),
    [KEY_G] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('g'), KEY_CHR('G')),
                   KEY_CHR('\x07')),
    [KEY_H] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('h'), KEY_CHR('H')),
                   KEY_CHR('\x08')),
    [KEY_I] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('i'), KEY_CHR('I')),
                   KEY_CHR('\x09')),
    [KEY_J] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('j'), KEY_CHR('J')),
                   KEY_CHR('\x0A')),
    [KEY_K] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('k'), KEY_CHR('K')),
                   KEY_CHR('\x0B')),
    [KEY_L] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('l'), KEY_CHR('L')),
                   KEY_CHR('\x0C')),
    [KEY_M] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_case, KEY_CHR('m'), KEY_CHR('M')),
                              KEY_CHR('\x0D')),
                   KEY_STR("µ")),
    [KEY_N] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('n'), KEY_CHR('N')),
                   KEY_CHR('\x0E')),
    [KEY_O] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('o'), KEY_CHR('O')),
                   KEY_CHR('\x0F')),
    [KEY_P] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('p'), KEY_CHR('P')),
                   KEY_CHR('\x10')),
    [KEY_Q] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('q'), KEY_CHR('Q')),
                   KEY_HANDLER(handle_ctrl_q)),
    [KEY_R] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('r'), KEY_CHR('R')),
                   KEY_CHR('\x12')),
    [KEY_S] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('s'), KEY_CHR('S')),
                   KEY_HANDLER(handle_ctrl_s)),
    [KEY_T] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('t'), KEY_CHR('T')),
                   KEY_CHR('\x14')),
    [KEY_U] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('u'), KEY_CHR('U')),
                   KEY_CHR('\x15')),
    [KEY_V] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('v'), KEY_CHR('V')),
                   KEY_CHR('\x16')),
    [KEY_W] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('w'), KEY_CHR('W')),
                   KEY_CHR('\x17')),
    [KEY_X] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('x'), KEY_CHR('X')),
                   KEY_CHR('\x18')),
    [KEY_Y] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('y'), KEY_CHR('Y')),
                   KEY_CHR('\x19')),
    [KEY_Z] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_case, KEY_CHR('z'), KEY_CHR('Z')),
                   KEY_CHR('\x1A')),
    [KEY_1_EXCLAMATION_MARK] =
        KEY_ROUTER(get_shift, KEY_CHR('1'), KEY_CHR('!')),
    [KEY_2_AT] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_shift, KEY_CHR('2'), KEY_CHR('"')),
                              KEY_CHR('\0')),
                   KEY_CHR('@')),
    [KEY_3_NUMBER_SIGN] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_shift, KEY_CHR('3'), KEY_CHR('#')),
                              KEY_CHR('\x1B')),
                   KEY_STR("£")),
    [KEY_4_DOLLAR] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_shift, KEY_CHR('4'), KEY_STR("¤")),
                              KEY_CHR('\x1C')),
                   KEY_CHR('$')),
    [KEY_5_PERCENT] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_shift, KEY_CHR('5'), KEY_CHR('%')),
                   KEY_CHR('\x1D')),
    [KEY_6_CARET] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_shift, KEY_CHR('6'), KEY_CHR('&')),
                   KEY_CHR('\x1E')),
    [KEY_7_AMPERSAND] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_shift, KEY_CHR('7'), KEY_CHR('/')),
                              KEY_CHR('\x1f')),
                   KEY_CHR('{')),
    [KEY_8_ASTERISK] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_ctrl,
                              KEY_ROUTER(get_shift, KEY_CHR('8'), KEY_CHR('(')),
                              KEY_CHR('\x7F')),
                   KEY_CHR('[')),
    [KEY_9_OPARENTHESIS] =
        KEY_ROUTER(get_alt_gr,
    ...
    [KEY_0_CPARENTHESIS] =
        KEY_ROUTER(get_alt_gr,
                   ...
                   KEY_CHR('}')),
    [KEY_ENTER] = KEY_ROUTER(get_new_line_mode, KEY_CHR('\x0D'), KEY_STR("\x0D\x0D")),
    [KEY_ESCAPE] = KEY_CHR('\x1B'),
    [KEY_BACKSPACE] =
        KEY_ROUTER(get_ctrl,
                   KEY_ROUTER(get_backspace_mode, KEY_CHR('\x7F'), KEY_CHR('\x08')),
    ...
    [KEY_BACKSLASH_VERTICAL_BAR] =
        KEY_ROUTER(get_shift, KEY_CHR('\''), KEY_CHR('*')),
    [KEY_SEMICOLON_COLON] =
        KEY_ROUTER(get_shift, KEY_STR("ö"), KEY_STR("Ö")),
    [KEY_SINGLE_AND_DOUBLE_QUOTE] =
    ...
    [KEY_DOT_GREATER] =
        KEY_ROUTER(get_shift, KEY_CHR('.'), KEY_CHR(':')),
    [KEY_SLASH_QUESTION] =
        KEY_ROUTER(get_shift, KEY_CHR('-'), KEY_CHR('_')),
    [KEY_CAPS_LOCK] = KEY_HANDLER(handle_caps_lock),
    [KEY_F1] = KEY_SS3_MOD_CSI("P"),
    [KEY_F2] = KEY_SS3_MOD_CSI("Q"),
    [KEY_F3] = KEY_SS3_MOD_CSI("R"),
    ...
    [KEY_HOME] =
        KEY_ROUTER(get_keyboard_compatibility,
                   ...
                   KEY_CSI("1~")),
    [KEY_PAGEUP] = KEY_CSI("5~"),
    [KEY_DELETE] = KEY_ROUTER(get_ctrl_alt,
                              KEY_CSI("3~"),
                              KEY_HANDLER(handle_ctrl_alt_delete)),
    [KEY_END1] =
        KEY_ROUTER(get_keyboard_compatibility,
    ...
    [KEY_KEYPAD_SLASH] =
        KEY_ROUTER(get_num,
                   KEY_ROUTER(get_ansi_mode, KEY_ESC("?o"), KEY_SS3("o")),
                   KEY_CHR('/')),
    [KEY_KEYPAD_ASTERIKS] =
        KEY_ROUTER(get_num,
                   KEY_ROUTER(get_ansi_mode, KEY_ESC("?j"), KEY_SS3("j")),
                   KEY_CHR('*')),
    [KEY_KEYPAD_MINUS] =
        KEY_ROUTER(get_num,
                   KEY_ROUTER(get_ansi_mode, KEY_ESC("?m"), KEY_SS3("m")),
                   KEY_CHR('-')),
    [KEY_KEYPAD_PLUS] =
        KEY_ROUTER(get_num,
                   KEY_ROUTER(get_ansi_mode, KEY_ESC("?k"), KEY_SS3("k")),
                   KEY_CHR('+')),
    [KEY_KEYPAD_ENTER] =
        KEY_ROUTER(get_num,
                   KEY_ROUTER(get_ansi_mode, KEY_ESC("?M"), KEY_SS3("M")),
    ...
    [KEY_NONUS_BACK_SLASH_VERTICAL_BAR] =
        KEY_ROUTER(get_alt_gr,
                   KEY_ROUTER(get_case, KEY_CHR('<'), KEY_CHR('>')),
                   KEY_CHR('|')),
