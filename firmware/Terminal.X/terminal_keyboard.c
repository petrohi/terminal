...
static const struct keys_entry *default_entries = (struct keys_entry[]){
    ...
    [KEY_F1] = KEY_STR("\033[11~"),
    [KEY_F2] = KEY_STR("\033[12~"),
    [KEY_F3] = KEY_STR("\033[13~"),
    [KEY_F4] = KEY_STR("\033[14~"),
    [KEY_F5] = KEY_STR("\033[15~"),
    [KEY_F6] = KEY_STR("\033[17~"),
    [KEY_F7] = KEY_STR("\033[18~"),
    [KEY_F8] = KEY_STR("\033[19~"),
    [KEY_F9] = KEY_STR("\033[20~"),
    [KEY_F10] = KEY_STR("\033[21~"),
    [KEY_F11] = KEY_STR("\033[23~"),
    [KEY_F12] = KEY_STR("\033[24~"),
    [KEY_SCROLL_LOCK] = KEY_HANDLER(handle_scroll_lock),
    [KEY_INSERT] = KEY_STR("\033[2~"),
    [KEY_HOME] =
        KEY_ROUTER(get_cursor_key_mode, KEY_STR("\033[H"), KEY_STR("\033OH")),
    [KEY_PAGEUP] = KEY_STR("\033[5~"),
    [KEY_DELETE] = KEY_ROUTER(get_ctrl_alt, KEY_STR("\033[3~"),
                              KEY_HANDLER(handle_ctrl_alt_delete)),
    [KEY_END1] =
        KEY_ROUTER(get_cursor_key_mode, KEY_STR("\033[F"), KEY_STR("\033OF")),
    [KEY_PAGEDOWN] = KEY_STR("\033[6~"),
    [KEY_RIGHTARROW] = KEY_ROUTER(
        get_ansi_mode, KEY_STR("\033C"),
        KEY_ROUTER(get_cursor_key_mode, KEY_STR("\033[C"), KEY_STR("\033OC"))),
    [KEY_LEFTARROW] = KEY_ROUTER(
        get_ansi_mode, KEY_STR("\033D"),
        KEY_ROUTER(get_cursor_key_mode, KEY_STR("\033[D"), KEY_STR("\033OD"))),
    [KEY_DOWNARROW] = KEY_ROUTER(
        get_ansi_mode, KEY_STR("\033B"),
        KEY_ROUTER(get_cursor_key_mode, KEY_STR("\033[B"), KEY_STR("\033OB"))),
    [KEY_UPARROW] = KEY_ROUTER(
        get_ansi_mode, KEY_STR("\033A"),
        KEY_ROUTER(get_cursor_key_mode, KEY_STR("\033[A"), KEY_STR("\033OA"))),
    [KEY_KEYPAD_NUM_LOCK_AND_CLEAR] = KEY_HANDLER(handle_num_lock),
    [KEY_KEYPAD_SLASH] = KEY_ROUTER(get_num, KEY_STR("\033Oo"), KEY_CHR('/')),
    [KEY_KEYPAD_ASTERIKS] =
        KEY_ROUTER(get_num, KEY_STR("\033Oj"), KEY_CHR('*')),
    [KEY_KEYPAD_MINUS] = KEY_ROUTER(get_num, KEY_STR("\033Om"), KEY_CHR('-')),
    [KEY_KEYPAD_PLUS] = KEY_ROUTER(get_num, KEY_STR("\033Ok"), KEY_CHR('+')),
    [KEY_KEYPAD_ENTER] = KEY_ROUTER(
        get_num, KEY_STR("\033OM"),
        KEY_ROUTER(get_new_line_mode, KEY_CHR('\x0d'), KEY_STR("\x0d\x0a"))),
    [KEY_KEYPAD_1_END] = KEY_ROUTER(get_num, KEY_STR("\033OF"), KEY_CHR('1')),
    [KEY_KEYPAD_2_DOWN_ARROW] =
        KEY_ROUTER(get_num, KEY_STR("\033[B"), KEY_CHR('2')),
    [KEY_KEYPAD_3_PAGEDN] =
        KEY_ROUTER(get_num, KEY_STR("\033[6~"), KEY_CHR('3')),
    [KEY_KEYPAD_4_LEFT_ARROW] =
        KEY_ROUTER(get_num, KEY_STR("\033[D"), KEY_CHR('4')),
    [KEY_KEYPAD_5] = KEY_ROUTER(get_num, KEY_STR("\033[E"), KEY_CHR('5')),
    [KEY_KEYPAD_6_RIGHT_ARROW] =
        KEY_ROUTER(get_num, KEY_STR("\033[C"), KEY_CHR('6')),
    [KEY_KEYPAD_7_HOME] = KEY_ROUTER(get_num, KEY_STR("\033OH"), KEY_CHR('7')),
    [KEY_KEYPAD_8_UP_ARROW] =
        KEY_ROUTER(get_num, KEY_STR("\033[A"), KEY_CHR('8')),
    [KEY_KEYPAD_9_PAGEUP] =
        KEY_ROUTER(get_num, KEY_STR("\033[5~"), KEY_CHR('9')),
    [KEY_KEYPAD_0_INSERT] =
        KEY_ROUTER(get_num, KEY_STR("\033[2~"), KEY_CHR('0')),
    [KEY_KEYPAD_DECIMAL_SEPARATOR_DELETE] =
        KEY_ROUTER(get_num,
                   KEY_ROUTER(get_ctrl_alt, KEY_STR("\033[3~"),
                              KEY_HANDLER(handle_ctrl_alt_delete)),
                   KEY_CHR('.')),
};
