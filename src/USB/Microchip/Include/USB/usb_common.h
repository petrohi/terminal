...
typedef enum
{
    ...
    // An endpoint 0 request was received that the stack did not know how to        // added by GRG to match EVENT_EP0_REQUEST in main()
    // handle.  This is most often a request for one of the class drivers.          // added by GRG to match EVENT_EP0_REQUEST in main()
    // Please refer to the class driver documenation for information related        // added by GRG to match EVENT_EP0_REQUEST in main()
    // to what to do if this request is received. (device)                          // added by GRG to match EVENT_EP0_REQUEST in main()
    GRG_EVENT_EP0_REQUEST = 3,                                                      // added by GRG to match EVENT_EP0_REQUEST in main()
